import {bl, br, tr, tl} from './RenderWebGL';

export const createShader = (gl: WebGL2RenderingContext, kind: number, source: string) => {
...
export const makeTextureAndStuff = (
...
export const defaultVertextShader = `#version 300 es
...
export var positions = new Float32Array(bl.concat(br, tr, bl, tr, tl));