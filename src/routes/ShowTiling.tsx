...
export const ShowTiling = ({
    tiling,
    data: {allSegments, shapes, bounds, marks, ttt},
    size = 300,
}: {
    tiling: Tiling;
    size?: number;
    ...
    // const [tilings, setTilings] = useState(0);
    // const lines: [Coord, Coord][] = bounds.map(
    //     (a, i) => [a, bounds[i === 0 ? bounds.length - 1 : i - 1]] as [Coord, Coord],
    // );
    // const allLines = applyTilingTransforms(lines, ttt.slice(0, tilings + 1));
    return (
        <div>
            <svg
